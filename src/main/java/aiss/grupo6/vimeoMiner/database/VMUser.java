...
public class VMUser {
    ...
    * assign an id to each new User with AutoIncrement.
    ...
    public static VMUser of(String name, String userLink, String pictureLink) {
        return new VMUser(name, userLink, pictureLink);
    }

    public static VMUser of(User u) {
        String pictureLink = u.getPictures().get("base_link").toString();
        return of(u.getName(), u.getUserLink(), pictureLink);
    }
